...
def get_extra_main_buttons() -> List[InlineKeyboardButton]:
    """Кнопки, которые добавляются в главное меню бота (плоский список —
    раскладка по колонкам делается в get_main_keyboard)."""
    return [
